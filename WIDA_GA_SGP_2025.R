...
###############################################################################
###                                                                         ###
###          Script to calculate SGPs for 2025 Georgia WIDA-ACCESS          ###
###                                                                         ###
###############################################################################
...
###   Load SGP object from 2024 analyses and 2025 cleaned/prepped long data
load("Data/WIDA_GA_SGP.Rdata")
load("Data/WIDA_GA_Data_LONG_2025.Rdata")
...
WIDA_GA_SGP <-
    updateSGP(
        ...
        with_sgp_data_LONG = WIDA_GA_Data_LONG_2025,
        steps = c(
...
WIDA_GA_SGP@Version[["session_platform"]][["2025"]] <- session_platform
WIDA_GA_SGP@Version[["attached_pkgs"]][["2025"]]    <- attached_pkgs
WIDA_GA_SGP@Version[["namespace_pkgs"]][["2025"]]   <- namespace_pkgs
...
#' 
#' The 2025 WIDA ACCESS for ELLs SGP results data are submitted to GaDOE
